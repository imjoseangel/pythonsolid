...
You can run it with the command `clear && python2 solid-examples/examples/bad/04_interfacesegregation/example01.py`
...
You can run it with the command `clear && python2 solid-examples/examples/good/04_interfacesegregation/example01.py`
